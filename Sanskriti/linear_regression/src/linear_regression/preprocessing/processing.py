...
def type_conversion(data_frame):
    ...
    data_frame["Screen_width"] = data_frame["Screen_width"].astype("int")
    data_frame["Screen_height"] = data_frame["Screen_height"].astype("int")
    ...
    data_frame["Cpu_frequency"] = data_frame["Cpu_frequency"].astype("float")
...
def pre_processing(dataset):
    ...
    X_test_scale.columns = X.columns
    scaled_data = [X_train_scale, X_test_scale, y_train, y_test]
